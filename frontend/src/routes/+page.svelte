...
<div class="min-h-screen bg-background font-sans">
	...
	<section class="py-16 px-6 border-t border-border/40">
		<div class="max-w-5xl mx-auto">
			<div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
				<div class="p-5 rounded-2xl bg-card border border-border/50 hover:border-primary/40 transition-colors group">
					...
					<h3 class="font-semibold text-foreground mb-1">Email Pooling</h3>
				...
				<div class="p-5 rounded-2xl bg-card border border-border/50 hover:border-primary/40 transition-colors group">
					...
					<h3 class="font-semibold text-foreground mb-1">Certificates</h3>
				...
				<div class="p-5 rounded-2xl bg-card border border-border/50 hover:border-primary/40 transition-colors group">
					...
					<h3 class="font-semibold text-foreground mb-1">Prize Pools</h3>
				...
				<div class="p-5 rounded-2xl bg-card border border-border/50 hover:border-primary/40 transition-colors group">
					...
					<h3 class="font-semibold text-foreground mb-1">CTFd Sync</h3>
	...
	<!-- Footer -->
	<footer class="border-t border-border/40 py-10 px-6 mt-auto">
		<div class="max-w-5xl mx-auto">
